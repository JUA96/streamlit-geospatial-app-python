...
DATE_TIME = "date/time"
DATA_URL = (
    "/Users/joseph_arber/Documents/DS/Projects/Apps/streamlit-python-apps/streamlit-geospatial-app-python/data.csv"
)

st.markdown("This application is a streamlit app which can be used to analyze vehicle collisions 💥 in New York City🗽")
